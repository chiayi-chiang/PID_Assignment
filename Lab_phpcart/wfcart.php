...
class wfCart {
	...
	function get_contents()//將購物車清單的內容存至陣列中
	{ // gets cart contents
		$items = array();
	...
	function add_item($itemid,$qty=1,$price = FALSE, $info = FALSE)//(商品編號,數量,價格,商品資訊)
	...
	function edit_item($itemid,$qty)//(商品編號,更新數量)
	...
	function _update_total()//更新購物車價格(total)和商品數量(iteamcount)
